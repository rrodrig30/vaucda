...
@pytest.mark.unit
class TestBOOIBCICalculatorCalculation:
    """Test BOOI/BCI calculations."""
...
@pytest.mark.calculator
@pytest.mark.unit
class TestBOOIBCICalculatorValidation:
    """Test input validation for BOOI/BCI."""
