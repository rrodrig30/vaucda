"""
Tests for Varicocele Grading Calculator.
...
@pytest.mark.unit
class TestVaricoceleCalculatorCalculation:
    """Test Varicocele Grading calculations."""
...
@pytest.mark.calculator
@pytest.mark.unit
class TestVaricoceleCalculatorValidation:
    """Test input validation for Varicocele Grading."""
