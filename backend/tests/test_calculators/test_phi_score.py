"""
Tests for PHI Score Calculator.
...
@pytest.mark.unit
class TestPHICalculatorCalculation:
    """Test PHI Score calculations."""
...
@pytest.mark.calculator
@pytest.mark.unit
class TestPHICalculatorValidation:
    """Test input validation for PHI Score."""
