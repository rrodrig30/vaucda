"""
Tests for NCCN Risk Calculator.
...
@pytest.mark.unit
class TestNCCNRiskCalculatorCalculation:
    """Test NCCN Risk calculations."""
...
@pytest.mark.calculator
@pytest.mark.unit
class TestNCCNRiskCalculatorValidation:
    """Test input validation for NCCN Risk."""
