"""
Tests for Semen Analysis WHO 2021 Calculator.
...
@pytest.mark.unit
class TestSemenAnalysisCalculatorCalculation:
    """Test Semen Analysis WHO 2021 calculations."""
...
@pytest.mark.calculator
@pytest.mark.unit
class TestSemenAnalysisCalculatorValidation:
    """Test input validation for Semen Analysis WHO 2021."""
