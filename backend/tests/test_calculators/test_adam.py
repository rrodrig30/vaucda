"""
Tests for ADAM Questionnaire Calculator.
...
@pytest.mark.unit
class TestADAMCalculatorCalculation:
    """Test ADAM Questionnaire calculations."""

    def setup_method(self):
        """Set up calculator instance."""
        self.calc = ADAMCalculator()
...
@pytest.mark.calculator
@pytest.mark.unit
class TestADAMCalculatorValidation:
    """Test input validation for ADAM Questionnaire."""
