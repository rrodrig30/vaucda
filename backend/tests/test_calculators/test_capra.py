"""
Tests for CAPRA Score Calculator.
...
@pytest.mark.unit
class TestCAPRACalculatorCalculation:
    """Test CAPRA Score calculations."""
...
@pytest.mark.calculator
@pytest.mark.unit
class TestCAPRACalculatorValidation:
    """Test input validation for CAPRA Score."""
