...
@pytest.mark.unit
class TestPVRUACalculatorCalculation:
    """Test PVR/UA calculations."""
...
@pytest.mark.calculator
@pytest.mark.unit
class TestPVRUACalculatorValidation:
    """Test input validation for PVR/UA."""
