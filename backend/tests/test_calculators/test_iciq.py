...
@pytest.mark.unit
class TestICIQCalculatorCalculation:
    """Test ICIQ-UI calculations."""
...
@pytest.mark.calculator
@pytest.mark.unit
class TestICIQCalculatorValidation:
    """Test input validation for ICIQ-UI."""
