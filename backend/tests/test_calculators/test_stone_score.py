"""
Tests for STONE Score Calculator.
...
@pytest.mark.unit
class TestStoneScoreCalculatorCalculation:
    """Test STONE Score calculations."""
...
@pytest.mark.calculator
@pytest.mark.unit
class TestStoneScoreCalculatorValidation:
    """Test input validation for STONE Score."""
