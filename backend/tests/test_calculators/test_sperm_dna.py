"""
Tests for Sperm DNA Fragmentation Calculator.
...
@pytest.mark.unit
class TestSpermDNACalculatorCalculation:
    """Test Sperm DNA Fragmentation calculations."""
...
@pytest.mark.calculator
@pytest.mark.unit
class TestSpermDNACalculatorValidation:
    """Test input validation for Sperm DNA Fragmentation."""
